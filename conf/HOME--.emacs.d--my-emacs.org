...
but it's actually a combination of input and output. When writing, writers of
...
Reading is indivisible from writing. To make reading more comfortable
when writing, I seperate the root window to two parts:
editing part and referencing part.
