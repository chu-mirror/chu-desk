...
Some activities might dont need to save state. Close the corresponding tabs
when quiting Emacs.
...
document, other part of code, debugger output, to get thought clearer
...
#+begin_src emacs-lisp :noweb-ref helpers
  (defvar-keymap my-activity-programming-keymap
    :doc "Keymap for my activity 'programming' related commands"
